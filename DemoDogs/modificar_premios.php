<?php
 ...
 $sql=$conn->query("select * from premios where id_premios=$id");
...
<head>
    ...
    <div id="sidebar">
        ...
        <!-- formulario para modificar los  premios de la serie con su respectivo controlador -->
</head>

  <div class ="container-center p -2">
 <form class="col-4 p-2 m-auto " method="POST">
    <h5 class ="text-center  alert alert-secondary ">Modificar Premios</h5>  
    <input type="hidden" name="id" value ="<?=$_GET["id"]?>">
 <?php
 include "Controlador/modificar_premio.php"; // controlador que  permite modificar datos y redirecionar a la pagina inicial 
  ...
  <div class="mb-0">
    ...
    <input type="text" class="form-control" name ="nominados"value="<?= $datos->nominados?>">
    
  </div>
  <div class="mb-0">
    <label for="exampleInputEmail1" class="form-label">Resultados</label>
    <input type="text" class="form-control" name ="resultados"value="<?= $datos->resultados?>">
